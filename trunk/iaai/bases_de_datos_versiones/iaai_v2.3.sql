...
INSERT INTO `alumno` (`id_alumno`,`nombre`,`apellido`,`dni`,`fecha_nac`,`telefono_carac`,`telefono_numero`,`escuela_nombre`,`escuela_año`,`direccion`,`id_responsable`) VALUES 
 ...
 (5,'Diego','Iriarte','28956734','1981-05-25','1234','123454','',0,'Obispo 345',0);
...
INSERT INTO `curso` (`id_curso`,`nombre`,`nivel`,`duracion`,`id_profesor`,`cupo`,`id_area`) VALUES 
 (1,'Ingles Inicial',1,3,1,10,2),
 (2,'Ingles Intermedio',2,2,8,10,2),
 (3,'Ingles Avanzado',3,3,1,10,2),
 (4,'Pintura Inicial',1,1,10,5,1),
 (5,'Danza Clasica',1,2,42,30,3);
...
INSERT INTO `curso_especial` (`id_curso_especial`,`nombre`,`horas_curso`,`id_profesor`,`cupo`,`id_area`) VALUES 
 (1,'Ingles Tecnico (Medicina)',50,43,25,2),
 (2,'Ingles Tecnico (Leyes)',60,49,20,2),
 (3,'Pintura al oleo',250,10,5,1),
 (4,'Grabado en Madera',150,41,5,1);
/*!40000 ALTER TABLE `curso_especial` ENABLE KEYS */;


--
-- Definition of table `inscripcion_materia`
--
